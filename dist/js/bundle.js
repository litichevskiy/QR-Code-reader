...
/***/ "./src/js/components/AlertCopyMessage.js":
/*!***********************************************!*\
  !*** ./src/js/components/AlertCopyMessage.js ***!
  \***********************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Alert__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Alert */ "./src/js/components/Alert.js");

const TIME_HIDE_TOOLTIP = 1500; // sec

class AlertCopyMessage extends _Alert__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor({
    container,
    btnCopy,
    copiedEl,
  ...
  showHideTooltip() {
    ...
    setTimeout(() => this.tooltip.classList.remove('active'), TIME_HIDE_TOOLTIP);
  }
}
;
/* harmony default export */ __webpack_exports__["default"] = (AlertCopyMessage);

/***/ }),

/***/ "./src/js/components/QRCodeGenerator.js":
/*!**********************************************!*\
  !*** ./src/js/components/QRCodeGenerator.js ***!
  \**********************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
const errors = {
  ...
  'max-length': `Maximum ${_config__WEBPACK_IMPORTED_MODULE_1__.MAX_LENGTH_FOR_QRCODE} symbols`
};
class QRCodeGenerator {
  constructor({
    ...
    this.quantitySimbols.innerHTML = _config__WEBPACK_IMPORTED_MODULE_1__.MAX_LENGTH_FOR_QRCODE;
  ...
  updateQuantitySymnols() {
    ...
    const quantity = _config__WEBPACK_IMPORTED_MODULE_1__.MAX_LENGTH_FOR_QRCODE - value.length;
    if (quantity < 0) this.quantitySimbols.classList.add('error');else if (quantity >= 0 && this.quantitySimbols.classList.contains('error')) {
      this.quantitySimbols.classList.remove('error');
    }
  ...
  isValidText(text) {
    ...
    if (_text.length < _config__WEBPACK_IMPORTED_MODULE_1__.MIN_LENGTH_FOR_QRCODE) {
      this.errorText = errors['min-length'];
    } else if (_text.length > _config__WEBPACK_IMPORTED_MODULE_1__.MAX_LENGTH_FOR_QRCODE) {
  ...
  generateQRCode(event) {
    ...
    if (!this.isValidText(value)) {
      ...
      qrcode__WEBPACK_IMPORTED_MODULE_0__.toCanvas(this.canvas, value, _config__WEBPACK_IMPORTED_MODULE_1__.OPTIONS_QR_CODE_GENERATOR, error => {
        if (error) this.alertError.showMessage(error.message);else {
...
;
/* harmony default export */ __webpack_exports__["default"] = (QRCodeGenerator);

/***/ }),

/***/ "./src/js/components/QRCodeReader.js":
/*!*******************************************!*\
  !*** ./src/js/components/QRCodeReader.js ***!
  \*******************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
class QRCodeReader {
  ...
  start() {
    ...
    this.startScan(_config__WEBPACK_IMPORTED_MODULE_1__.MEDIA_PARAMS_MOBILE);
  }
  stop() {
  ...
  setCanvasSizes() {
    ...
    this.canvasElementWidth = width, this.canvasElementHeight = height;
  ...
  startScan(options) {
    navigator.mediaDevices.getUserMedia(options).then(mediaStream => {
      ...
      if (message === 'Permission denied' || message === 'PermissionDeniedError') {
        ...
        this.startScan(_config__WEBPACK_IMPORTED_MODULE_1__.MEDIA_PARAMS_DESCTOP);
  ...
  _tickScan() {
    ...
    if (readyState === VIDEO_HAVE_ENOUGH_DATA) {
      this.canvas.drawImage(this.video, 0, 0, this.canvasElementWidth, this.canvasElementHeight);
      const {
        data,
        width,
        height
      } = this.canvas.getImageData(0, 0, this.canvasElementWidth, this.canvasElementHeight);
...
;
/* harmony default export */ __webpack_exports__["default"] = (QRCodeReader);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _utils_getParentNode__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/getParentNode */ "./src/js/utils/getParentNode.js");
...
class TabNavigation {
  ...
  changeActiveTab({
    ...
    target = (0,_utils_getParentNode__WEBPACK_IMPORTED_MODULE_0__["default"])(target, 'button');
...
/***/ "./src/js/components/checkSupport.js":
/*!*******************************************!*\
  !*** ./src/js/components/checkSupport.js ***!
  \*******************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony default export */ __webpack_exports__["default"] = (checkSupport);
...
/* harmony export */   MAX_LENGTH_FOR_QRCODE: function() { return /* binding */ MAX_LENGTH_FOR_QRCODE; },
/* harmony export */   MEDIA_PARAMS_DESCTOP: function() { return /* binding */ MEDIA_PARAMS_DESCTOP; },
/* harmony export */   MEDIA_PARAMS_MOBILE: function() { return /* binding */ MEDIA_PARAMS_MOBILE; },
/* harmony export */   MIN_LENGTH_FOR_QRCODE: function() { return /* binding */ MIN_LENGTH_FOR_QRCODE; },
/* harmony export */   OPTIONS_QR_CODE_GENERATOR: function() { return /* binding */ OPTIONS_QR_CODE_GENERATOR; }
/* harmony export */ });
const MEDIA_PARAMS_MOBILE = {
  video: {
    facingMode: {
      exact: "environment"
    }
...
const MEDIA_PARAMS_DESCTOP = {
  video: {
    facingMode: "user"
  }
};
const OPTIONS_QR_CODE_GENERATOR = {
  width: 300,
  margin: 1,
  'color': {
    dark: '#242121'
...
const MAX_LENGTH_FOR_QRCODE = 600; // symbols
const MIN_LENGTH_FOR_QRCODE = 1; // symbol
...
/* harmony default export */ __webpack_exports__["default"] = (swRegister);

/***/ }),

/***/ "./src/js/utils/getParentNode.js":
/*!***************************************!*\
  !*** ./src/js/utils/getParentNode.js ***!
  \***************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony default export */ __webpack_exports__["default"] = (getParentNode);
...
/*!*************************!*\
  ...
  \*************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _serviceWorkerRegister__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./serviceWorkerRegister */ "./src/js/serviceWorkerRegister.js");
/* harmony import */ var _components_checkSupport__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/checkSupport */ "./src/js/components/checkSupport.js");
/* harmony import */ var _components_QRCodeReader__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/QRCodeReader */ "./src/js/components/QRCodeReader.js");
/* harmony import */ var _components_QRCodeGenerator__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/QRCodeGenerator */ "./src/js/components/QRCodeGenerator.js");
/* harmony import */ var _components_TabNavigation__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/TabNavigation */ "./src/js/components/TabNavigation.js");
/* harmony import */ var _components_Alert__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/Alert */ "./src/js/components/Alert.js");
/* harmony import */ var _components_AlertCopyMessage__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/AlertCopyMessage */ "./src/js/components/AlertCopyMessage.js");
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  Promise.resolve(_components_checkSupport__WEBPACK_IMPORTED_MODULE_1__["default"].mediaDevices()).then(response => {
    if (!response.isSupported) throw new Error(response.message);
    (0,_serviceWorkerRegister__WEBPACK_IMPORTED_MODULE_0__["default"])();
    const alertError = new _components_Alert__WEBPACK_IMPORTED_MODULE_5__["default"]({
    ...
    const alertCopyMessage = new _components_AlertCopyMessage__WEBPACK_IMPORTED_MODULE_6__["default"]({
    ...
    const defautAlert = new _components_Alert__WEBPACK_IMPORTED_MODULE_5__["default"]({
    ...
    new _components_TabNavigation__WEBPACK_IMPORTED_MODULE_4__["default"]({
      container: document.querySelector('.tab-navigation'),
      tabList: [...document.querySelectorAll('.tab')],
      activeTabId: 0
    });
    new _components_QRCodeReader__WEBPACK_IMPORTED_MODULE_2__["default"]({
    ...
    new _components_QRCodeGenerator__WEBPACK_IMPORTED_MODULE_3__["default"]({
    ...
    new _components_Alert__WEBPACK_IMPORTED_MODULE_5__["default"]({
      container: document.querySelector('.alert-error'),
      btnClose: document.querySelector('.alert-error .close-alert'),
      content: document.querySelector('.alert-error .alert-content')
